...
AppName=Atualização SICEMDF-e 3.6
AppVerName=3.6
...
OutputBaseFilename=SICEMDFE_Atualização
Compression=lzma
...
Source: ..\midas.dll; DestDir: c:\iqsistemas\SICEMDF-e
Source: ..\libxmlsec-openssl.dll; DestDir: c:\iqsistemas\SICEMDF-e
Source: ..\dbexpmda.dll; DestDir: c:\iqsistemas\SICEMDF-e
...
Source: ..\Schemas\evInclusaoDFeMDFe_v3.00.xsd; DestDir: c:\iqsistemas\SICEMDF-e\Schemas\
...
Source: ..\Schemas\retMDFe_v3.00.xsd; DestDir: c:\iqsistemas\SICEMDF-e\Schemas\
...
[Run]
Filename: {app}\gerarIP.bat
[InstallDelete]
Name: c:\iqsistemas\SICEMDF-e\SICEMDFe.exe; Type: files
[Dirs]
